...
trainFile="/Users/apple/Documents/data/test20171124/testday6.csv"
pwd = os.getcwd()
    ...
    for j in range(1,549):
        ...
        for k in range(1,422):  
          ...
          if float(df3['wind'])<20:
              ...
              df_con.iloc[j-1,k-1]=-1
    df_con.to_csv("/Users/apple/Documents/data/test20171124/model1/model1_day6_hour"+str(i)+".csv",index=False,header=False)
...
df5.to_csv('/Users/apple/Documents/data/testday10.csv')
df1.to_csv('/Users/apple/Documents/data/testday6.csv')
df2.to_csv('/Users/apple/Documents/data/testday7.csv')
df3.to_csv('/Users/apple/Documents/data/testday8.csv')
df4.to_csv('/Users/apple/Documents/data/testday9.csv')
df5.to_csv('/Users/apple/Documents/data/testday10.csv')
'''
